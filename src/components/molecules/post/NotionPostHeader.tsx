...
export default function NotionPostHeader({
  ...
  return (
    <div className="w-full">
      <h1 className="break-keep text-center leading-snug tracking-tight">{title}</h1>
      <div className="flex flex-col items-center gap-5 py-5">
        ...
        <Thumbnail
          ...
          wrapClassName="aspect-[3/2] w-full max-w-xl rounded-2xl backdrop-blur-md border border-white/10 shadow-[var(--shadow)]"
        />
